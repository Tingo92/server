...
test('User has no hours out of range selected', async () => {
...
test('All hours out of range are selected - (Daylight Saving)', async () => {
  // EST Time Zone for dates
...
test('Some hours out of range are selected - (Daylight Saving)', async () => {
  // EST Time Zone for dates
